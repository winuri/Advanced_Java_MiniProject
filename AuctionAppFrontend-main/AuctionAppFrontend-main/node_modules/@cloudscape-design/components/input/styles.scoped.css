...
.awsui_input_2rhyz_dvvio_97.awsui_input-readonly_2rhyz_dvvio_118:not(#\9) {
  background-color: var(--color-background-input-default-u57378, #ffffff);
  border: var(--border-field-width-idlekx, 2px) solid var(--color-border-input-disabled-x2lopj, #e9ebed);
}
.awsui_input_2rhyz_dvvio_97:not(#\9)::-webkit-input-placeholder {
  color: var(--color-text-input-placeholder-j53j3c, #5f6b7a);
  font-style: italic;
  -webkit-user-select: none;
          user-select: none;
}
.awsui_input_2rhyz_dvvio_97:not(#\9)::-ms-input-placeholder {
  color: var(--color-text-input-placeholder-j53j3c, #5f6b7a);
  font-style: italic;
}
.awsui_input_2rhyz_dvvio_97:not(#\9)::-moz-placeholder {
  color: var(--color-text-input-placeholder-j53j3c, #5f6b7a);
  font-style: italic;
  opacity: 1;
}
...
.awsui_input_2rhyz_dvvio_97:not(#\9):focus {
...
.awsui_input_2rhyz_dvvio_97:not(#\9):disabled {
...
.awsui_input_2rhyz_dvvio_97:not(#\9):disabled::-webkit-input-placeholder {
  color: var(--color-text-input-placeholder-disabled-6928j8, #9ba7b6);
  -webkit-user-select: none;
          user-select: none;
}
.awsui_input_2rhyz_dvvio_97:not(#\9):disabled::-ms-input-placeholder {
  color: var(--color-text-input-placeholder-disabled-6928j8, #9ba7b6);
}
.awsui_input_2rhyz_dvvio_97:not(#\9):disabled::-moz-placeholder {
  color: var(--color-text-input-placeholder-disabled-6928j8, #9ba7b6);
  opacity: 1;
}
.awsui_input_2rhyz_dvvio_97:not(#\9):disabled:-ms-input-placeholder {
...
.awsui_input_2rhyz_dvvio_97:not(#\9):invalid {
  box-shadow: none;
}
.awsui_input_2rhyz_dvvio_97.awsui_input-invalid_2rhyz_dvvio_179:not(#\9) {
...
.awsui_input_2rhyz_dvvio_97.awsui_input-invalid_2rhyz_dvvio_179:not(#\9):focus {
...
.awsui_input_2rhyz_dvvio_97.awsui_input-invalid_2rhyz_dvvio_179.awsui_input-has-icon-left_2rhyz_dvvio_190:not(#\9) {
  padding-left: calc(
        var(--space-field-icon-offset-25xih0, 36px) - (var(--border-invalid-width-5jpdqn, 8px) - var(--border-field-width-idlekx, 2px))
      );
}
.awsui_input_2rhyz_dvvio_97.awsui_input-type-search_2rhyz_dvvio_195:not(#\9) {
  box-sizing: border-box;
  -webkit-appearance: none; /* stylelint-disable-line plugin/no-unsupported-browser-features */
}
.awsui_input_2rhyz_dvvio_97.awsui_input-type-search_2rhyz_dvvio_195:not(#\9)::-ms-clear {
  display: none;
}
.awsui_input_2rhyz_dvvio_97.awsui_input-type-search_2rhyz_dvvio_195:not(#\9)::-webkit-search-decoration {
  -webkit-appearance: none; /* stylelint-disable-line plugin/no-unsupported-browser-features */
}
.awsui_input_2rhyz_dvvio_97.awsui_input-type-search_2rhyz_dvvio_195:not(#\9)::-webkit-search-cancel-button {
  display: none;
}
.awsui_input_2rhyz_dvvio_97.awsui_input-has-icon-left_2rhyz_dvvio_190:not(#\9) {
  padding-left: var(--space-field-icon-offset-25xih0, 36px);
}
.awsui_input_2rhyz_dvvio_97.awsui_input-has-icon-right_2rhyz_dvvio_211:not(#\9) {
  padding-right: var(--space-field-icon-offset-25xih0, 36px);
}
.awsui_input_2rhyz_dvvio_97.awsui_input-has-no-border-radius_2rhyz_dvvio_214:not(#\9) {
  border-radius: var(--border-radius-dropdown-ujknaf, 8px);
}

.awsui_input-container_2rhyz_dvvio_218:not(#\9) {
  display: flex;
  position: relative;
}

.awsui_input-icon_2rhyz_dvvio_223:not(#\9) {
  position: absolute;
}
.awsui_input-icon_2rhyz_dvvio_223:not(#\9):not(.awsui_input-icon-hoverable_2rhyz_dvvio_226) {
  pointer-events: none;
}

.awsui_input-icon-left_2rhyz_dvvio_230:not(#\9) {
  left: var(--space-field-horizontal-89h2yr, 12px);
  top: calc(50% - var(--font-body-m-line-height-i7xxvv, 22px) / 2);
}

.awsui_input-icon-right_2rhyz_dvvio_235:not(#\9) {
  right: var(--space-field-horizontal-89h2yr, 12px);
  top: calc(50% - var(--font-body-m-line-height-i7xxvv, 22px) / 2);
  color: var(--color-text-button-inline-icon-default-w65lqn, #0972d3);
}

.awsui_input-icon-hoverable_2rhyz_dvvio_226:not(#\9) {
  cursor: pointer;
}
.awsui_input-icon-hoverable_2rhyz_dvvio_226:not(#\9):hover {
